...
export const routes = [
    ...
    { path: "card-info", component: CardInfoComponent, canActivate: [AuthGuard]},
    { path: "", redirectTo: 'agreement', pathMatch: 'full'}, /* @TODO: create guard for redirecting to card-info if user is already accepted */
